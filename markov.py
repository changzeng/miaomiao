...
class Markov:
    ...
    def initial_parameter(self):
        # 初始化参数
        try:
            import data.prob_emit, data.prob_trans, data.prob_start
            self.emit_matrix = data.prob_emit.P
            self.transfer_matrix = data.prob_trans.P
            self.start_matrix = data.prob_start.P
